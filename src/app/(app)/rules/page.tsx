    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
          Automatically categorize transactions by matching their description or merchant name.
          Rules run on every new transaction, and can also be applied to existing ones.
        </p>
      </div>
